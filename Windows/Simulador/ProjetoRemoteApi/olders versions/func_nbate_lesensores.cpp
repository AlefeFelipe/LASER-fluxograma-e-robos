...
int main(int argc, char **argv)
{
  ...
  ///conexao com elementos da cena
	...
	while(simxGetConnectionId(clientID)!=-1 )
    {
        ...
        leituraLVS = DataLVS[10]<0.1;//media da intensidade. No caso preto, sao todos 0
        leituraLMVS = DataLMVS[10]<0.1;
        leituraMVS = DataMVS[10]<0.1;
        leituraRMVS = DataRMVS[10]<0.1;
        leituraRVS = DataRVS[10]<0.1;
